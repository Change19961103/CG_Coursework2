...
public:
    ...
    static Vec3f* render_BVH(Camera* camera, Scene* scene, int nbounces);
    ...
    static Vec3f castRay_BVH(int nbounces, const std::vector<LightSource *> &lights_list, Ray ray, Vec3f bgcolor, BVH a);
